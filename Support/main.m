...
int main(int argc, char *argv[]) {
       ...
       @autoreleasepool {
        ...
        // Set the PYTHONPATH
        python_path = [NSString stringWithFormat:@"PYTHONPATH=%@/:%@/python/electrum:%@/python/python-trezor/src:%@/Library/Application Support/so.onekey.one.OneKey/app_packages", resourcePath, resourcePath, resourcePath, resourcePath,  nil];
